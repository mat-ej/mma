...
filename = os.path.join(current_file, '../../temporary_models/BCE.pt')
...
# train net
train_model(train_set, validation_set_size_ratio, net_model, loss_function, dataset_name, batch_size, optimizer,
